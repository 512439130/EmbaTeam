 ...
 * 我参加的协会
 */
public class JoinAssociationFragment extends BaseLazyFragment {
    private static final String TAG = "JoinAssociationFragment";
    ...
    protected int getLayoutId() {
        return R.layout.fragment_join_association;
    }
    @Override
