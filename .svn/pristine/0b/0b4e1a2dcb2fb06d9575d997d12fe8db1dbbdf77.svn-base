 ...
 * 保存手机号
 */
public class SavePhoneInputPopup extends BasePopupWindow implements View.OnClickListener{
    ...
    public SavePhoneInputPopup(Activity context, CallBack callBack, String title) {
        super(context);
...
//        setDismissWhenTouchOuside(true);  //点击屏幕外是否dismiss
    ...
    public View onCreatePopupView() {
        return LayoutInflater.from(getContext()).inflate(R.layout.popup_input_save_phone,null);
    }
